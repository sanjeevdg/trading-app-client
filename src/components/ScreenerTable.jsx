...
//192.168.150.105:5000
  const res = await axios.get(
    `${API_BASE}/api/tv/indicators/${symbol}?timeframe=1d`
  );
...
//candlestick-screener.onrender.com
    ...
    switch (type) {
      case "top-gainers":
        endpoint = `${API_BASE}/api/tv/top-gainers`;
        break;
      case "volume-leaders":
        endpoint = `${API_BASE}/api/tv/volume-leaders`;
        break;
      case "best-performing":
        endpoint = `${API_BASE}/api/tv/best-performing`;
        break;
      case "small-cap":
        endpoint = `${API_BASE}/api/tv/small-cap`;
        break;  
      default:
